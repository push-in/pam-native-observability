...
final class Span
{
    ...
    public function __construct(
        private readonly Observability $owner,
    ...
    public function status(SpanStatus $status): self
    {
        $this->status = $status;
    ...
    public function exception(Throwable $error): self
    {
        $this->status = SpanStatus::Error;
        $this->attributes['exception.type'] = $error::class;
